...
const Image = (props) => {
    const { foto01, foto02, foto03, fotoLuiz } = useStaticQuery(graphql`
    query {
        ...
        fotoLuiz: file(relativePath: { eq: "img-luiz.png" }) {
          childImageSharp {
  ...
  return(
    ...
    {(() => {
        switch (props.name) {
            ...
            case 'fotoLuiz':
              return <Img fluid={fotoLuiz.childImageSharp.fluid} alt="Imagem do Luiz" />     
            default:
              return null
        }
    })()}
